          ...
          <div className='mb-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
              <div>
                ...
                <p className='font-medium'>{log.subject?.hotel?.name ?? "N/A"}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className='font-medium'>{log.subject?.confirmation_number ?? "N/A"}</p>
              </div>
              <div>
                <p className='text-sm text-muted-foreground'>Check-in</p>
                <p className='font-medium'>{log.subject?.check_in?.toString() ?? "N/A"}</p>
              </div>
              <div>
                <p className='text-sm text-muted-foreground'>Check-out</p>
                <p className='font-medium'>{log.subject?.check_out?.toString() ?? "N/A"}</p>
              </div>
              <div>
