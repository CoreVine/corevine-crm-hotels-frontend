...
import { UpdateClientModal } from "@/app/dashboard/clients/_components/update";
...
export const ClientForm = ({ client, form, setHasClient, defaultClient }: Props) => {
  const [searchClients, setSearchClientsValue] = useState(defaultClient);
