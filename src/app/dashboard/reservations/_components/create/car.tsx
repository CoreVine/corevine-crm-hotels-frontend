...
export const CarForm = ({ form }: Props) => {
  const [searchDrivers, setSearchDriversValue] = useState<string>("");
  ...
  return (
    <div className='space-y-4 border p-4 rounded-md shadow'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
        ...
        <InputField
          name='car.meeting_point'
          label='Meeting Point'
          placeholder='Terminal 1 Arrivals'
          control={form.control}
        />

        <InputField
          name='car.coming_from'
          label='Coming From'
          placeholder='New York'
          control={form.control}
        />

        <SelectField name='car.status' control={form.control} label='Status'>
